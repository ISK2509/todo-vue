...
import { reactive } from 'vue';
  ...
  const getTarefasPendentes = () => {
    return estado.tarefas.filter(tarefa => !tarefa.finalizada) //! é de negacao
  }
  ...
  <div class="container">
    ...
    <ul class="list-group mt-4">
      <li class="list-group-item" v-for="tarefa in getTarefasFiltradas()">
        ...
        <label :class="{ done: tarefa.finalizada }" class="ms-3" :for="tarefa.titulo"> <!--ms é margin start, me é margin end-->
          {{ tarefa.titulo }}
        </label>
      </li>
    </ul>
